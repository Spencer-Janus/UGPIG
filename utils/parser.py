...
def parse_args():
    parser = argparse.ArgumentParser(description="UGPIG")

    # ===== dataset ===== #
    parser.add_argument("--dataset", nargs="?", default="SDG", help="Choose a dataset:[last-fm,amazon-book,alibaba]")
    parser.add_argument(
    ...
    parser.add_argument('--Ks', nargs='?', default='[1,3,5]', help='Output sizes of every layer')
    ...
    parser.add_argument("--user_argg", type=str, default="add", help="add concat inner product")
